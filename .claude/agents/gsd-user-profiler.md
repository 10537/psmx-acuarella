...
<reference>
@/home/gideon/wks_odoo/psmx-acuarella/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/gideon/wks_odoo/psmx-acuarella/.claude/get-shit-done/references/user-profiling.md` to load:

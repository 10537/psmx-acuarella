...
- Usage: Reference from command with `@/home/gideon/wks_odoo/psmx-acuarella/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/gideon/wks_odoo/psmx-acuarella/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/gideon/wks_odoo/psmx-acuarella/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

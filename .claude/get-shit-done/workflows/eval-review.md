...
```bash
AUDITOR_MODEL=$(node "/home/gideon/wks_odoo/psmx-acuarella/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /home/gideon/wks_odoo/psmx-acuarella/.claude/agents/gsd-eval-auditor.md for instructions.

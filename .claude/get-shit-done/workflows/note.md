...
- **Global scope**: `/home/gideon/wks_odoo/psmx-acuarella/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/gideon/wks_odoo/psmx-acuarella/.claude/notes/`)
...
2. Glob `/home/gideon/wks_odoo/psmx-acuarella/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/gideon/wks_odoo/psmx-acuarella/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/gideon/wks_odoo/psmx-acuarella/.claude/notes/` — works in any directory
